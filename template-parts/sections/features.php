 ...
 * Features
 * 
 * Cards from VR Content > Features
 * 
...
?>
<section id="features" class="pnvr-section" aria-labelledby="features-heading">
    <div class="container container-2xl">

        <header class="pnvr-section-header" data-scroll-reveal>
            <span class="pnvr-eyebrow"><?php esc_html_e( 'Capabilities', 'pn-vr' ); ?></span>
            <h2 id="features-heading"><?php esc_html_e( 'Everything a Visual Regression Run Needs', 'pn-vr' ); ?></h2>
