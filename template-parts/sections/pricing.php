 ...
 * Pricing
 * 
 * Tier cards from VR Content > Pricing, the monthly / annual switch, and the Trial vs Paid comparison table
 * 
...
?>
<section id="pricing" class="pnvr-section" aria-labelledby="pricing-heading">
    <div class="container container-2xl">

        <header class="pnvr-section-header" data-scroll-reveal>
            <span class="pnvr-eyebrow"><?php esc_html_e( 'Pricing', 'pn-vr' ); ?></span>
            <h2 id="pricing-heading"><?php esc_html_e( 'Start Free. Scale When It Earns Its Keep.', 'pn-vr' ); ?></h2>
