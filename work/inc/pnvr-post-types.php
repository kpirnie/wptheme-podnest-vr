 ...
 * Post Types Class
 * 
 * Registers the content post types (marquee, features, pricing tiers) and their meta boxes
 * 
...
if( ! class_exists( 'PNVR_Post_Types' ) ) {
    ...
    */
    class PNVR_Post_Types {
         ...
         * meta_boxes
         * 
         * Registers the feature and pricing meta boxes with the field framework
         * 
         * @author Kevin Pirnie <iam@kevinpirnie.com>
         * @copyright 2025 Kevin Pirnie
         * 
